                ...
                <div class="col-md-12">
                    <table class="table table-condensed table-striped table-bordered table-hover">
                        <thead class="bg-primary" align="center">
                            ...
                            <th class="sort asc h4">idVariante</th>
                            <th class="sort asc h4">idControl</th>
                            <th class="sort asc h4">minutos</th>
                            <th class="sort asc h4">toleracia</th>
                            <th class="sort asc h4">tipoDias</th>
                            <th class="sort asc h4">horaDesde</th>
                            <th class="sort asc h4">horaHasta</th>
                            <th class="sort asc h4">idTablaValores</th>
