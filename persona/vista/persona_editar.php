...
<?php if (isset($_GET["success"])) echo '<div class="alert alert-info" role="alert"> Persona registrada correctamente..</div>'; ?> 
    ...
    <div class="row">         
      <div class="col-md-12">
           <h2 align="center" class="titulos">Actualizar Persona</h2>
                ...
                <div class="card-body">
                 ...
                 <div class="form-group">
                  <select name="idRol" id="idRol" class="form-control  input-md">
                            ...
                            <option <?php echo $vte->idRol==='1'?"selected='selected'":""?> value="1">Chofer</option>
                            <option <?php echo $vte->idRol==='2'?"selected='selected'":""?> value="2">Propietario</option>
                            <option <?php echo $vte->idRol==='3'?"selected='selected'":""?> value="3">Administrador</option>
