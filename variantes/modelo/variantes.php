...
class Variantes
{
	...
	public function Registrar(Variantes $data)
	{
		...
		$sql = "INSERT INTO variante (idVariante,nombreVariante, sentido, numeroVariante, estadoVariante,frecMax,frecMin,frecNormal,mediaVuelta,proximaVariante,primeraSalida,colorVariante) 
		        VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";	 	
