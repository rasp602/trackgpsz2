...
include '../../bd/conexionLocal.php'; //incluir el archivo de conexion
	...
	if($action == 'ajax'){
		include 'pagination_hotel.php'; //incluir el archivo de paginación
...
if ($nombreHotel!="") {
  ...
  echo "Busca empresa"; 
      	...
      	$count_query1 = mysqli_query($con,"SELECT count(*) AS numrows1 FROM hotel	$where");
...
$query = mysqli_query($con,"SELECT * FROM hotel $where
ORDER by idHotel LIMIT $offset,$per_page");
		...
		<table class="table table-condensed table-striped table-bordered table-hover" id="tabla">
            ...
            <td class="contenidoTabla"><?php echo utf8_encode($row['idHotel']);?></td>
            <td class="contenidoTabla"><?php echo utf8_encode($row['rutHotel']);?></td>
            <td class="contenidoTabla"><?php echo utf8_encode($row['nombreHotel']);?></td>
            <td class="contenidoTabla"><?php echo utf8_encode($row['direccion']);?></td>
            <td class="contenidoTabla"><?php echo utf8_encode($row['capacidadHotel']);?></td>
