...
<div class="container-fluid">
     ...
     <?php if (isset($_GET["delete"])) echo '<div class="alert alert-warning" role="alert">Variante eliminada correctamente..</div>'; ?> 
        
     <?php if (isset($_GET["update"])) echo '<div class="alert alert-warning" role="alert">Variante actulizada correctamente..</div>'; ?>
...
<?php include_once 'variantes/vista/variantes.php'; ?>
</div>
