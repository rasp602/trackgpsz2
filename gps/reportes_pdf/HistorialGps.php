...
function Header()
{
    ...
    $this->Cell(0, 8, 'REGISTRO DE GPS', 0, 1, 'C');
    ...
    $this->Row(array('#','IMEI GPS','SIM CARD','MODELO'));
    ...
    function Footer()
    {
        ...
        $this->Cell(130, 10, ' ', 0);
        $this->Cell(150, 10, 'Historial de GPS', 0, 0, 'L');
    }
}
...
$query3 = mysqli_query($con,
    "SELECT * FROM gps $where
     ORDER BY gps.idGps ASC"
);
