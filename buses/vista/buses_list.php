...
<div class="container-fluid">
     ...
     <?php if (isset($_GET["success"])) echo '<div class="alert alert-info" role="alert"> Bus registrado correctamente..</div>'; ?> 

     <?php if (isset($_GET["delete"])) echo '<div class="alert alert-warning" role="alert">Bus eliminado correctamente..</div>'; ?> 
        
     <?php if (isset($_GET["update"])) echo '<div class="alert alert-warning" role="alert">Bus actulizado correctamente..</div>'; ?>
