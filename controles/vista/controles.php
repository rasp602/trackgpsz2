<head>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-auto h5" align="center">
                 <a href="?c=controles&a=Crud"><span class="fas fa-clock" style='font-size:48px'></span>
                 <p>Agregar Control</p></a>
            </div>
        </div> 
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-condensed table-striped table-bordered table-hover">
                        <thead class="bg-primary" align="center">
                            ...
                            <th class="sort asc h4">Abreviación</th>
                            <th class="sort asc h4">Tipo de Control</th>
                            <th class="sort asc h4">Longitud1</th>
                            <th class="sort asc h4">Longitud2</th>
                            <th class="sort asc h4">Latitud1</th>
                            <th class="sort asc h4">Latitud2</th>
                            <th class="sort asc h4">Angulo de entrada</th>
                            <th class="sort asc h4">Toleracia Entrada</th>
                            <th class="sort asc h4">Velocidad Maxima</th>
                            <th class="sort asc h4">Estado</th>
                            <th class="sort asc h4">Sentido</th>
                            <th class="sort asc h4">Visible</th>
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "controles/vista/loadControles.php"
