            ...
            <div class="card card-primary">
              ...
              <div class="col-md-6">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Longitud 1</label>
                    <input type="text" class="form-control" id="longitud1" name="longitud1" value="<?php echo $vte->longitud1;?>"  placeholder="Ingresa la Abreviación">
                  </div>   
