<head>
<script src="roles/js/ajaxRoles.js"></script>
</head> 
    <div class="container-fluid">
        ...
        <div class="col-auto h5">
            <a href="?c=roles&a=Crud"><i class='fas fa-user-tag' style='font-size:48px'></i>
                 <p>Agregar Rol</p></a>
        </div>
                ...
                <div class="col-md-12">
                    <table class="table table-condensed table-striped table-bordered table-hover">
                        <thead class="bg-primary" align="center">
                            ...
                            <th class="sort asc h4">Nombre Rol</th>
                            <th class="sort asc h4">Descripción Rol</th>
                            <th class="sort asc h4">Estado Rol</th>
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "roles/vista/loadRoles.php"
